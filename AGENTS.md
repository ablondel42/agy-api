...
- **Workspace Virtual Environment Only**: ALWAYS use the virtual environment located within the active workspace (e.g., `src/.venv/bin/python`, `src/.venv/bin/<binary>` or `.venv/bin/<binary>`).
