...
from agy_process import AgyProcessError
...
class TestChatCompletionsNonStreaming:
    ...
    async def test_basic_completion(self, client):
        ...
        with patch("routes.chat.run_agy", new_callable=AsyncMock, return_value=mock_result) as mock:
...
class TestChatCompletionsStreaming:
    ...
    async def test_multi_turn_streaming_continuation(self, client):
        ...
        with patch("routes.chat.stream_agy", side_effect=mock_stream_turn1):
        ...
        with patch("routes.chat.stream_agy", side_effect=mock_stream_turn2):
